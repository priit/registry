...
RSpec.feature 'Subscribe to billing subscription' do
  background do
  ...
  scenario 'subscribes' do
    ...
    click_link_or_button 'registrar_billing_subscription_subscribe_btn'
    ...
    expect(page).to have_text('Billing subscription has been activated.')
  end
